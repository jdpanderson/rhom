...
Model.statics = {
  ...
  get: function(id, callback) {
    ...
    emitEvent(this._mdl.events, 'get', this, id, callback);
  },
  /**
  ...
  all: function(callback) {
    emitEvent(this._mdl.events, 'all', this, undefined, callback);
  },
  ...
  purge: function(callback) {
    emitEvent(this._mdl.events, 'purge', this, undefined, callback);
  }
};
...
Model.instance = {
  ...
  save: function(callback) {
    ...
    emitEvent(this.self._mdl.events, 'save', this, undefined, callback);
  },
  ...
  delete: function(callback) {
    emitEvent(this.self._mdl.events, 'delete', this, undefined, callback);
  },
...
function emitEvent(emitter, type, target, data, callback) {
  ...
  /* Return early if the before handler handled it. */
