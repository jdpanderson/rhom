 ...
 */
function ModelEvent(type, target, data, callback) {
  this.type = type;
  this.target = target;
  this.data = data;
...
ModelEvent.prototype = {
   ...
   */
    ...
    this.claimed = true; /* Done implies claimed. */
    this.finished = true;
...
Model.statics = {
  ...
  get: function(id, callback) {
    ...
    emitEvent(this.events, 'get', this, id, callback);
  },
  /**
  ...
  all: function(callback) {
    emitEvent(this.events, 'all', this, undefined, callback);
  },
  ...
  purge: function(callback) {
    emitEvent(this.events, 'purge', this, undefined, callback);
  },
...
Model.instance = {
  ...
  save: function(callback) {
    ...
    emitEvent(this.self.events, 'save', this, undefined, callback);
  },
  ...
  delete: function(callback) {
    emitEvent(this.self.events, 'delete', this, undefined, callback);
  },
...
function emitEvent(emitter, type, target, data, callback) {
  ...
  var cb = function() {
    emitter.emit('modelAfter' + Type, evt);
    if (typeof callback === 'function') {
      callback.apply(undefined, arguments);
    }
  };

  var evt = new ModelEvent(type, target, data, cb);
  emitter.emit('modelBefore' + Type, evt);
  emitter.emit('model' + Type, evt);
