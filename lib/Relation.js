...
Intermediary.prototype = {
  ...
  to: function(relation, pluralize) {
    ...
    this.obj._mdl.plugin("Relation:" + name, "Relationship to " + name);
...
function Relation(obj) {
  ...
  return {
    ...
    toOne: function(relation) {
      ...
      var mdl = obj._mdl.plugin("Relation:" + name, "Relation to " + name);
    ...
    toMany: function(relation) {
      ...
      var name = relation.name;
      var mdl = obj._mdl.plugin("Relation" + names, "Relation to " + names);
